...
wsl -u root -- bash -c "apt-get update && apt-get install -y make tar tor curl python3 python3-scapy network-manager obfs4proxy proxychains4 rfkill secure-delete iptables"
